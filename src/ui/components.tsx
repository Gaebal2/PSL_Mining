...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: palette.surface, borderColor: palette.border, borderWidth: 1, borderRadius: 24, padding: 18, gap: 12, shadowColor: '#232A46', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.08, shadowRadius: 24, elevation: 3 },
  button: { minHeight: 52, borderRadius: 16, backgroundColor: palette.gold, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 18, shadowColor: palette.goldDark, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.2, shadowRadius: 12, elevation: 2 },
